...
namespace StringLanguageExtensions
{
    public static class General
    {
        ...
        /// <summary>
        /// Trim last character from a string while the stock <see cref="string.TrimEnd()"/> will trim multiples e.g. given Hello!! will return Hello while this extension given Hello!! will return Hello!
        /// </summary>
        /// <param name="sender">string to work on</param>
